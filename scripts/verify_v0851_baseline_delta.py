#!/usr/bin/env python3
"""Verify exact full-record v0.85.0 -> v0.85.1 model deltas."""
...
OLD_PACKAGE = "@earendil-works/pi-ai@0.85.0"
NEW_PACKAGE = "@earendil-works/pi-ai@0.85.1"
OLD_PACKAGE_SHA256 = "46188bdacb555a07466a0111f3963f20932a16199e4d6cfb8d44a7fe5fc6e342"
NEW_PACKAGE_SHA256 = "af7d11986179445ce6fe88b37d57de22f823c0ffd3a65cae31c555b7f5e99253"
EXPECTED_TEXT = (20, 2, 18)
EXPECTED_IMAGE = (2, 0, 0)
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="rs-ai-v0851-delta-") as tmp:
        work = Path(tmp)
        ...
        if failures:
            ...
            return 1
        print(
            "v0.85.1 baseline delta verified: "
