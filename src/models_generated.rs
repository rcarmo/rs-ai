...
pub fn builtin_models() -> Vec<Model> {
    vec![
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 0.22_f64, output: 0.55_f64, cache_read: 0.12_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 262144,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 0.75_f64, output: 3.5_f64, cache_read: 0.16_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 262144,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.21_f64, output: 0.455_f64, cache_read: 0.06_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 1000000,
            max_tokens: 4096,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 0.45_f64, output: 3_f64, cache_read: 0.225_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 65536,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.2_f64, output: 0.8_f64, cache_read: 0.05_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 131072,
            headers: None,
            api_key: None,
