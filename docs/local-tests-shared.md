...
## v0.82.0 release catalog/metadata/runtime disposition fixture

Source: upstream tag `083e61621276bff9f6faefab87ce07fcd98734e2` (`v0.82.0`), exact release-only delta `20be4b18d4c57487f8993d2762bace129f0cf7c6..083e61621276bff9f6faefab87ce07fcd98734e2`. rs-ai adaptation: regenerated `src/models_generated.rs` and `src/images/models_generated.rs`, plus `src/v0820_release_test.rs`, `src/retry.rs`, `src/context.rs`, `src/env.rs`, `src/utils.rs`, `src/provider/openai.rs`, and the JSON-shard-aware comparator.

Status: **ADAPTED**. The v0.81.1→v0.82.0 release span changes 96 `packages/ai` paths. Catalog/generator/model-data validation, generated image/model JSON shape, image catalog additions, Qwen Token Plan providers/env, shared text/UUIDv7 utilities, retry abort-finished/provider retry semantics, overflow phrase matching, OpenCode Go Responses support, OpenAI-completions pipe-delimited tool-call ID uniqueness, Kimi/K3/xAI/OpenRouter/OpenCode/Gemini metadata, and related deterministic tests are represented by regenerated registries and Rust tests. README/changelog/package/TS build metadata and credential/browser OAuth matrix edits are N/A for Rust runtime. Expected comparator: `PI_AI_MODEL_DATA_DIR=/workspace/tmp/pi-v0820-json scripts/compare_upstream_registry_pairs.py /workspace/tmp/pi-v0820 083e61621276bff9f6faefab87ce07fcd98734e2` -> text `1116/1116`, image `40/40`, missing `0`, extra `0`.
