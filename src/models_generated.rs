...
//!
//! Source: models.generated.js (1109 models, 37 providers)
//! Generated: 2026-07-25T18:45:52.457691Z
...
pub fn builtin_models() -> Vec<Model> {
    vec![
        ...
        Model {
            id: "au.anthropic.claude-opus-5".into(),
            name: "Claude Opus 5 (AU)".into(),
            api: "bedrock-converse-stream".into(),
            provider: "amazon-bedrock".into(),
            base_url: "https://bedrock-runtime.us-east-1.amazonaws.com".into(),
            reasoning: true,
        ...
        Model {
            id: "eu.anthropic.claude-opus-5".into(),
            name: "Claude Opus 5 (EU)".into(),
            api: "bedrock-converse-stream".into(),
            provider: "amazon-bedrock".into(),
            base_url: "https://bedrock-runtime.eu-central-1.amazonaws.com".into(),
            reasoning: true,
        ...
        Model {
            id: "jp.anthropic.claude-opus-5".into(),
            name: "Claude Opus 5 (JP)".into(),
            api: "bedrock-converse-stream".into(),
            provider: "amazon-bedrock".into(),
            base_url: "https://bedrock-runtime.us-east-1.amazonaws.com".into(),
            reasoning: true,
        ...
        Model {
            id: "us.anthropic.claude-opus-5".into(),
            name: "Claude Opus 5 (US)".into(),
            api: "bedrock-converse-stream".into(),
            provider: "amazon-bedrock".into(),
            base_url: "https://bedrock-runtime.us-east-1.amazonaws.com".into(),
            reasoning: true,
        ...
        Model {
            ...
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 1_f64, output: 6_f64, cache_read: 0.1_f64, cache_write: 1.25_f64, tiers: vec![ModelCostTier { input_tokens_above: 200000_u64, input: 2_f64, output: 9_f64, cache_read: 0.2_f64, cache_write: 2.5_f64 }] },
            context_window: 1050000,
            max_tokens: 128000,
            headers: Some(HashMap::from([("User-Agent".into(), "GitHubCopilotChat/0.35.0".into()), ("Editor-Version".into(), "vscode/1.107.0".into()), ("Editor-Plugin-Version".into(), "copilot-chat/0.35.0".into()), ("Copilot-Integration-Id".into(), "vscode-chat".into())])),
            api_key: None,
        ...
        Model {
            ...
            name: "Deep Research Max Preview (Apr-21-2026)".into(),
        ...
        Model {
            ...
            name: "Deep Research Preview (Apr-21-2026)".into(),
            api: "google-generative-ai".into(),
            provider: "google".into(),
            base_url: "https://generativelanguage.googleapis.com/v1beta".into(),
            reasoning: true,
        ...
        Model {
            ...
            name: "Gemini 2.5 Computer Use Preview 10-2025".into(),
            api: "google-generative-ai".into(),
            provider: "google".into(),
            base_url: "https://generativelanguage.googleapis.com/v1beta".into(),
            reasoning: true,
        ...
        Model {
            ...
            name: "Kimi For Coding HighSpeed".into(),
            api: "anthropic-messages".into(),
            provider: "kimi-coding".into(),
            base_url: "https://api.kimi.com/coding".into(),
            reasoning: true,
        ...
        Model {
            id: "laguna-s-2.1-free".into(),
            name: "Laguna S 2.1 Free".into(),
            api: "openai-completions".into(),
            provider: "opencode".into(),
            base_url: "https://opencode.ai/zen/v1".into(),
            reasoning: true,
        ...
        Model {
            id: "anthropic/claude-opus-5-fast".into(),
            name: "Claude Opus 5 (Fast)".into(),
            api: "openai-completions".into(),
            provider: "openrouter".into(),
            base_url: "https://openrouter.ai/api/v1".into(),
            reasoning: true,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.22_f64, output: 0.85_f64, cache_read: 0.06_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 262144,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.269_f64, output: 0.4_f64, cache_read: 0.1345_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 163840,
            max_tokens: 65536,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 1.5_f64, output: 7.5_f64, cache_read: 0.15_f64, cache_write: 0.083333_f64, tiers: vec![] },
            context_window: 1048576,
            max_tokens: 65536,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.05_f64, output: 0.08_f64, cache_read: 0.025_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 131072,
            max_tokens: 131072,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 0.646_f64, output: 2.72_f64, cache_read: 0.1088_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 262144,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 0.78_f64, output: 3.5_f64, cache_read: 0.15_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 262144,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.085_f64, output: 0.4_f64, cache_read: 0_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 16384,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.037_f64, output: 0.17_f64, cache_read: 0_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 131072,
            max_tokens: 131072,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.1_f64, output: 0.2_f64, cache_read: 0.01_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 1048576,
            max_tokens: 131072,
            headers: None,
            api_key: None,
        ...
        Model {
            id: "poolside/laguna-s-2.1:free".into(),
            name: "Poolside: Laguna S 2.1 (free)".into(),
            api: "openai-completions".into(),
            provider: "openrouter".into(),
            base_url: "https://openrouter.ai/api/v1".into(),
            reasoning: true,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.1_f64, output: 1.1_f64, cache_read: 0.07_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 262144,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 0.21_f64, output: 1.9_f64, cache_read: 0.1_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 131072,
            max_tokens: 32768,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into(), "image".into()],
            cost: ModelCost { input: 0.39_f64, output: 2.34_f64, cache_read: 0_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 262144,
            max_tokens: 65536,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 1.475_f64, output: 4.425_f64, cache_read: 0.295_f64, cache_write: 1.84375_f64, tiers: vec![] },
            context_window: 1000000,
            max_tokens: 65536,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            name: "Thinking Machines: Inkling".into(),
            api: "openai-completions".into(),
            provider: "openrouter".into(),
            base_url: "https://openrouter.ai/api/v1".into(),
            reasoning: true,
        ...
        Model {
            ...
            thinking_level_map: None,
            input: vec!["text".into()],
            cost: ModelCost { input: 0.5_f64, output: 2_f64, cache_read: 0.1_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 202752,
            max_tokens: 131072,
            headers: None,
            api_key: None,
        ...
        Model {
            ...
            input: vec!["text".into()],
            cost: ModelCost { input: 0.7042_f64, output: 2.2132_f64, cache_read: 0.13078_f64, cache_write: 0_f64, tiers: vec![] },
            context_window: 1048576,
            max_tokens: 131072,
            headers: None,
            api_key: None,
        ...
        Model {
            id: "anthropic/claude-opus-4.8-fast".into(),
            name: "Claude Opus 4.8 (Fast)".into(),
            api: "anthropic-messages".into(),
            provider: "vercel-ai-gateway".into(),
            base_url: "https://ai-gateway.vercel.sh".into(),
            reasoning: true,
